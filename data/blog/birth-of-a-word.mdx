...
tags: ['speech']
type: Blog
summary: "Discussing Deb Roy's fascinating TED talk on how infants learn language by utilizing big data visualization and analytics."
---
...
There are incredible feedback loops, some subconscious, that affect how we speak and how children learn language. Roy discovered a correlation between the average length of the utterance containing a word, and the time at which it came part of a child's vocabulary. The graph below illustrates the correlation:

![Utterance Graph](/static/images/birth-of-a-word/utterance.png)
...
![Obama Speech Analysis](/static/images/birth-of-a-word/obama.png)
