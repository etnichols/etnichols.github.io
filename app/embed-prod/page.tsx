...
export default function EmbedProd() {
  return (
    <>
      ...
      <Script>{`
      var ${PROD_APP_ID};(function(d, t){
      var s=d.createElement(t),
      options={"appId":"${PROD_APP_ID}","width":"800","height":"800","async":true,"host":"quiz.tryinteract.com","mobile":true};
      s.src='https://i.tryinteract.com/embed/app.js';
      s.onload=s.onreadystatechange=function(){
        var rs=this.readyState;if(rs)if(rs!='complete')if(rs!='loaded')
        return;
      try{app_${PROD_APP_ID}=new InteractApp();
      ${PROD_APP_ID}.initialize(options);app_${PROD_APP_ID}.display();}catch(e){}};
