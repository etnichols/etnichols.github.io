...
export const data: [ISection] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "Developed a React Native iOS application which allows users to interact with 38 different views of the human body, with the goal of improving biopsy labeling accuracy in a laboratory setting. See more at https://apple.co/2Uu5tUT."
      },
      {
